...
2. Ensure the root contains `.git`, `AGENTS.md`, `CODEX_HANDOFF.md`, and `.codex/skills/`.
3. Start Codex and paste:
...
The complete context and next work sequence are in `CODEX_HANDOFF.md`.
