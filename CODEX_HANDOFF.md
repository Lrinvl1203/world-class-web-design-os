...
- PR #19 made the entry tests base-path aware after post-deploy QA showed that `page.goto('/')` discarded the GitHub Pages repository path. The deployed site subsequently passed 6/6 launch and hard-gate checks at 320 and 1440 px. The v0.2.0 release now carries the 15-second MP4 and poster, and Discussion #6 records the evidence update at `https://github.com/Lrinvl1203/world-class-web-design-os/discussions/6#discussioncomment-18019724`.
